...
const QuizListContent = () => {
    ...
    return (
        <div>
            ...
            <div className="bg-white/60 backdrop-blur-glass backdrop-saturate-150 rounded-2xl shadow-glass-md border-0">
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-warm-200/40 bg-warm-50/50">
                                    <th className="px-6 py-4 font-mono text-[11px] uppercase tracking-wider text-ink-500 font-semibold rounded-tl-2xl">Title</th>
